...
# Claude Design v2 업데이트

상세 기능 브리프를 Claude Design 프로젝트에 전달해 `KBO GameDay 목업 세트 v2`를 생성했다.

- 프로젝트: https://claude.ai/design/p/0a12651a-0bf9-45c6-9ba6-57a7eee8dc3e
- 반영 화면: 모바일 오늘, 예매 임박, 주간 일정, 기기별 설정, 데스크톱 월간, 12회 경기 상세
- 반영 상태: 예매 오픈 전/예매 중, LIVE, 종료, 취소, 연기
- 반영 원칙: 원정 왼쪽·홈 오른쪽, 12이닝 수평 스크롤, 색상 외 텍스트·형태 상태 구분, 390px/1440px 검증
- 기기 설정: 로그인 없이 브라우저 로컬 저장 및 초기화 안내
